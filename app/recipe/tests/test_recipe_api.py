...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_update_user_returns_error(self):
        ...
        new_user = create_user(email='other@example.com', password='pased123')
        recipe = create_recipe(user=self.user)
    ...
    def test_recipe_create_recipe_with_new_tags(self):
        payload = {
            'title': 'Prawn Curry',
            'time_minutes': 30,
            'price': Decimal('2.50'),
    ...
    def test_create_tag_on_update(self):
        """Test Creating tag when updaating a recipe"""
        recipe = create_recipe(user=self.user)
        payload = {
            'tags': [{'name': 'Lunch'}]
        }
    ...
    def test_create_recipe_with_new_ingredient(self):
        ...
        payload = {
            ...
            'time_minutes': 60,
            'price': Decimal(2.99),
            'ingredients': [{'name': 'meat'}, {'name': 'tortilla'}]
        }
        res = self.client.post(RECIPES_URL, payload, format='json')
